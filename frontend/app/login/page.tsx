        ...
        <div className="w-full max-w-md mx-4">
          <div className="bg-nf-secondary rounded-2xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="font-heading text-2xl font-bold text-nf-white">欢迎回来</h1>
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-nf-dark bg-nf-dark hover:bg-nf-dark/80 transition-colors">
                ...
                <span className="text-nf-white">使用 Google 登录</span>
              </button>
              <button className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-nf-dark bg-nf-dark hover:bg-nf-dark/80 transition-colors">
                ...
                <span className="text-nf-white">使用 GitHub 登录</span>
              </button>
            </div>
            ...
            <p className="text-center text-sm text-nf-muted mt-6">
              还没有账号？{" "}
              <Link href="/register" className="text-nf-lime hover:underline">
                注册
              </Link>
            </p>
          </div>
